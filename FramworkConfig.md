...
$env:Path = [System.Environment]::GetEnvironmentVariable("Path","Machine") + ";" + [System.Environment]::GetEnvironmentVariable("Path","User"); cd d:\Hotel; git submodule add https://github.com/TojoTR/Framework_sprint.git framework  (ovaina Pseudo sy anaranle repository anle framework)